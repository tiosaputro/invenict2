...
class LaporanReqDivReqPerStatus implements FromView
{
    /**
    * @return \Illuminate\Support\Collection
    */
    function __construct($statusRequestor) {
        $this->statusRequestor = $statusRequestor;
    }
    public function view(): View
    {
        ...
        ->where('imm.ireq_status',$this->statusRequestor)
