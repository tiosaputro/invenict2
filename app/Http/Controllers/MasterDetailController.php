...
class MasterDetailController extends Controller
{
    ...
    public function addDetail($code)
    {
    ...
    public function editDetail($code)
    {
    ...
    public function updateDetail(Request $request, $code)
    {
        $newDate = Carbon::parse($request->invent_tgl_perolehan)->copy()->tz('Asia/Jakarta')->format('Y-m-d');
    ...
    public function deleteDetail($invent_code_dtl)
    {
