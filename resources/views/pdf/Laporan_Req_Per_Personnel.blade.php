		...
		<div class="">
			<div class="row justify-content-center">
				<div class="col-md-7 text-center mb-5">
					<h2 style="font-size:30pt; font-weight: bold;"> Laporan Request Per ICT-Personnel </h2>
					...
					<div>
						...
						<thead>
							<tr>
								...
								<th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Nama ICT-Personnel</th>
