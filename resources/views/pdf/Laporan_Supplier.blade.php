					...
					<div>
						...
						<thead>
							<tr>
								...
								<th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Contact</th>
								<th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Alamat 1</th>
								<th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Alamat 2</th>
								<th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Kota</th>
								<th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Email</th>
								<th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Fax</th>
								<th style="font-size:12pt; font-weight: bold; background-color:#807a6b">No.Tlp 1</th>
								<th style="font-size:12pt; font-weight: bold; background-color:#807a6b">No.Tlp 2</th>
							</tr>
						</thead>
						<tbody>
						@foreach($supp as $s)
