                                ...
                                <thead>
                                    <tr>
                                        <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Nama
                                            Suplier</th>
                                        <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Tgl.
                                            Pembelian</th>
                                        <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Cara
                                            Pembayaran</th>
                                        <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Petugas
                                        </th>
                                        <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Mata
                                            Uang</th>
                                        <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Total
                                            Pembayaran</th>
