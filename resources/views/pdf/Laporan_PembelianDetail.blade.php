                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Nama
                                        Peripheral</th>
                                    <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Jumlah(Qty)
                                    </th>
                                    <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Satuan</th>
                                    <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Harga Satuan
                                    </th>
                                    <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Total Harga
                                    </th>
