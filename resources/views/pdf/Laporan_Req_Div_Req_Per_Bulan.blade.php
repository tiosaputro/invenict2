        ...
        <div class="">
            <div class="row justify-content-center">
                <div class="col-md-10 text-center mb-5">
                    <h2 style="font-size:30pt; font-weight: bold;"> Laporan Request Divisi Requestor
                        {{$status[0]->bulan}} {{$status[0]->tahun}} </h2>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Divisi
                                            Requestor</th>
                                        <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Jumlah
                                            Request</th>
                                    </tr>
                                </thead>
                            <tbody>
