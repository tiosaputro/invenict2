                            ...
                            <thead>
                                <thead>
                                    <tr>
                                        ...
                                        <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">
                                            Peripheral</th>
                                        <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Merk
                                        </th>
                                        <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Type
                                        </th>
                                        <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">S/N</th>
                                        <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">User
                                        </th>
                                        <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Location
                                        </th>
                                        <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">From
                                            Date</th>
                                        <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">To Date
                                        </th>
                                    </tr>
                                </thead>
                            <tbody>
