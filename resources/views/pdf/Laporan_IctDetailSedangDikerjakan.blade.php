    ...
    <section class="ftco-section">
        <div>
            ...
            <div class="col-md-12">
                ...
                <div class="footer">
                    <h6 style="text-align:justify;font-weight: bold;"> Tgl. Request : {{ formatDate($detail[0]->ireq_date, 'd M y') }}</h6>
                ...
                <div>
                    <table class="table table-striped">
                        <thead>
                            <thead>
                                <tr>
                                    <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Tipe Request
                                    </th>
                                    <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Nama
                                        Peripheral</th>
                                    <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Deskripsi
                                    </th>
                                    <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Qty</th>
                                    <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">Keterangan
                                    </th>
                                    <th style="font-size:12pt; font-weight: bold; background-color:#807a6b">ICT
                                        Personnel</th>
                                </tr>
                            </thead>
                        <tbody>
