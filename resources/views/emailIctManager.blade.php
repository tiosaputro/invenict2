		...
		<div>
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-6">
					...
					<h2>
						<a class="buttonapprove" href="http://localhost:8000/ictinv_resp_mng/{{$link->link_id}}/approve">
							<button type="submit">Approve</button>
    					</a>
  					</h2>
					<h2>
    					<a class="buttonreject" href="http://localhost:8000/ictinv_resp_mng/{{$link->link_id}}/reject">
