                    ...
                    <form @submit.prevent="UpdateIctDetail">
                        <div class="field grid">
                            ...
                            <div class="col-fixed w-9rem">
                                <InputText type="text" v-model="ict.ireq_no" disabled />
                            </div>
                        </div>
                        <div class="field grid">
                            <label class="col-fixed w-9rem" style="width:120px">Request Type</label>
                            <div class="col-fixed w-9rem">
                                <Dropdown :options="type" type="text" v-model="ict.ireq_type" optionLabel="name"
                                    optionValue="code" placeholder="Select One" @change="getIreq(ireq_type)"
                                    :showClear="true" :class="{ 'p-invalid': error.ireq_type }" />
                        ...
                        <div class="field grid" v-if="this.cekTipeReq">
                            ...
                            <div class="col-fixed w-9rem">
                                <TreeSelect v-model="kode" :options="catalog" placeholder="Select Catalog"
                                    display="chip" :class="{ 'p-invalid': errors.invent_code }"
                                    @change="change(kode)" />
                        ...
                        <div class="field grid" v-if="this.cekTipeReq =='P'">
                            ...
                            <div class="col-fixed w-9rem">
                                <InputNumber v-model="ict.ireq_qty" placeholder="Enter Qty"
                        ...
                        <div class="field grid">
                            ...
                            <div class="col-fixed w-9rem">
                                <Textarea :autoResize="true" rows="5" type="text" v-model="ict.ireq_remark"
                                    placeholder="Enter Remark" :class="{ 'p-invalid': errors.ireq_remark }" />
  ...
  methods: {
    ...
    getIct(){
        this.axios.get('/api/edit-ict-detail/' +this.$route.params.ireq+'/'+this.$route.params.code,).then((response)=>{
          ...
          this.catalog = response.data.data.tree;
