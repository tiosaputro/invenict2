    ...
    <div class="col-12">
      <div class="card">
        ...
        <DataTableRequestorRequest 
          v-if="this.desc == 1" :value="ict" :loading="loading" :showRemark="showRemarkRequestorWaiting" :showSpv="showSpvRequestorWaiting"
          :filters="filters" printPdf="tab_reviewer" @get-data="getIct" :showForDashboard=true Active="1"
        />
        ...
        <DataTableRequestorRequest 
          v-if="this.desc == 2" :value="sdhDiverifikasi" :loading="loading" :showRemark="showRemarkRequestorVerified" :showSpv="showSpvRequestorVerified"
          :filters="filters" printPdf="verifikasi" @get-data="getIct" :showForDashboard=true Active="2"
        />
        ...
        <DataTableRequestorRequest 
          v-if="this.desc == 3" :value="diReject" :loading="loading" :showRemark="showRemarkRequestorRejected" :showSpv="showSpvRequestorRejected"
          :filters="filters" printPdf="reject" @get-data="getIct" :showForDashboard=true Active="3"
        />
        ...
        <DataTableRequestorRequest 
          v-if="this.desc == 4" :value="sdgDikerjakan" :loading="loading" :showRemark="showRemarkRequestorInProgress" :showSpv="showSpvRequestorInProgress"
          :filters="filters" printPdf="sedang_dikerjakan" @get-data="getIct" :showForDashboard=true Active="5"
        />
        ...
        <DataTableRequestorDetail 
          v-if="this.desc == 5" :value="sdhDikerjakan" :showForDashboard=true @show-loading="showLoading" @hide-loading="hideLoading" @get-data="getIct" :loading="loading" printPdf="sudah_dikerjakan"
        />
        ...
        <DataTableRequestorDetail 
          v-if="this.desc == 6" :value="sdhSelesai" :showForDashboard=true @show-loading="showLoading" @hide-loading="hideLoading" @get-data="getIct" :loading="loading" printPdf="selesai" 
        /> 
        ...
        <DataTableReviewerRequest v-if="this.desc == 14" :value="sudahDiassign" :loading="loading" :showRemark="ForReviewer.showRemarkSudahDiassign" :showSpv="ForReviewer.showSpvSudahDiassign"
        ...
        <DataTableReviewerDetail v-if="this.desc == 15" :value="sudahDikerjakann" @get-data="getIct" :loading="loading" @show-loading="showLoading" @hide-loading="hideLoading" printPdf="sudah_dikerjakan"/>
        ...
        <DataTableReviewerDetail 
          v-if="this.desc == 16" :value="sudahslsi" @get-data="getIct" :loading="loading" @show-loading="showLoading" @hide-loading="hideLoading" printPdf="selesai"
        />   
        ...
        <DataTableManagerDetail v-if="this.desc == 20" :value="sdHDikerjakan4" @show-loading="showLoading" @hide-loading="hideLoading" @get-data="getIct5" :showForDashboard=true :loading="loading" printPdf="sudah_dikerjakan" />
        <Toolbar class="mb-4" v-if="this.desc == 21">
          <template v-slot:start>
                <h4>ICT Request (Close)</h4>
          </template>
        </Toolbar>   
        <DataTableManagerDetail v-if="this.desc == 21" :value="selesai4" @show-loading="showLoading" @hide-loading="hideLoading" @get-data="getIct5" :showForDashboard=true :loading="loading" printPdf="selesai" />
        ...
        <DataTableRequestorRequest 
          v-if="this.desc == 22" :value="total" :loading="loading" :showRemark="showRemarkRequestorTotal" :showSpv="showSpvRequestorTotal"
          :filters="filters" printPdf="verifikasi" @get-ict="getIct" :showForDashboard=true
        />
        ...
        <DataTableManagerRequest v-if="this.desc == 33" :value="blmDiverifikasi4" :loading="loading" :showRemarkReviewer="ForIctManager.showRemarkReviewerblmDiverifikasi4" :showRemarkManager="ForIctManager.showRemarkManagerblmDiverifikasi4"
          :showSpv="ForIctManager.showSpvblmDiverifikasi4" printPdf="permohonan" :showPersonnel1="ForIctManager.showPersonnelblmDiverifikasi4" @get-data="getIct5" Active="0" 
        ...
        <DataTableManagerRequest v-if="this.desc == 34" :value="sdhDiverifikasi4" :loading="loading" :showRemarkReviewer="ForIctManager.showRemarkReviewersdhDiverifikasi4" :showRemarkManager="ForIctManager.showRemarkManagersdhDiverifikasi4"
          :showSpv="ForIctManager.showSpvsdhDiverifikasi4" printPdf="verifikasi" :showPersonnel1="ForIctManager.showPersonnelsdhDiverifikasi4" @get-data="getIct5" Active="1" 
          @show-loading="showLoading" @hide-loading="hideLoading" :showForDashboard=true
        />
        ...
        <DataTableManagerRequest v-if="this.desc == 35" :value="direject4" :loading="loading" :showRemarkReviewer="ForIctManager.showRemarkReviewerdireject4" :showRemarkManager="ForIctManager.showRemarkManagerdireject4"
          :showSpv="ForIctManager.showSpvdireject4" printPdf="reject" :showPersonnel1="ForIctManager.showPersonneldireject4" @get-data="getIct5" Active="2" 
        ...
        <DataTableManagerRequest v-if="this.desc == 36" :value="sdgDikerjakan4" :loading="loading" :showRemarkReviewer="ForIctManager.showRemarkReviewersdgDikerjakan4" :showRemarkManager="ForIctManager.showRemarkManagerpenugasanRequest4"
          :showSpv="ForIctManager.showSpvsdgDikerjakan4" printPdf="assignment_request" :showPersonnel1="ForIctManager.showPersonnelsdgDikerjakan4" @get-data="getIct5" Active="0" 
          @show-loading="showLoading" @hide-loading="hideLoading" :showForDashboard=true
        />
        ...
        <DataTableReviewerRequest v-if="this.desc == 37" :value="totalRequest2" :loading="loading" :showRemark="ForReviewer.showRemarkTotalRequest2" :showSpv="ForReviewer.showSpvTotalRequest2"
          printPdf="permohonan" :showPersonnel1="ForReviewer.showPersonelTotalRequest2" @get-data="getIct" Active="0" @show-loading="showLoading" @hide-loading="hideLoading" :showForDashboard=true 
        />
        ...
        <DataTableManagerRequest v-if="this.desc == 39" :value="totalRequest4" :loading="loading" :showRemarkReviewer="ForIctManager.showRemarkReviewertotalRequest4" :showRemarkManager="ForIctManager.showRemarkManagertotalRequest4"
          :showSpv="ForIctManager.showSpvtotalRequest4" printPdf="assignment_request" :showPersonnel1="ForIctManager.showPersonneltotalRequest4" @get-data="getIct5" Active="0" 
          @show-loading="showLoading" @hide-loading="hideLoading" :showForDashboard=true
        />
        ...
        <DataTableRequestorRequest 
          v-if="this.desc == 40" :value="sedangDireview" :loading="loading" :showRemark="showRemarkRequestorPermohonan" :showSpv="showSpvRequestorPermohonan"
          :filters="filters" printPdf="permohonan" @get-ict="getIct" :showForDashboard=true
        />
        ...
        <DataTableManagerRequest v-if="this.desc == 42" :value="sedangDireview2" :loading="loading" :showRemarkReviewer="ForIctManager.showRemarkReviewersedangDireview2" :showRemarkManager="ForIctManager.showRemarkManagerDireview2"
          :showSpv="ForIctManager.showSpvDireview2" printPdf="permohonan" :showPersonnel1="ForIctManager.showPersonnelDireview2" @get-data="getIct5" Active="0" 
          @show-loading="showLoading" @hide-loading="hideLoading" :showForDashboard=true
        />
        ...
        <DataTableReviewerRequest v-if="this.desc == 43" :value="penugasanRequest2" :loading="loading" :showRemark="ForReviewer.showRemarkPenugasanRequest2" :showSpv="ForReviewer.showSpvPenugasanRequest2"
        ...
        <DataTableManagerRequest v-if="this.desc == 44" :value="penugasanRequest4" :loading="loading" :showRemarkReviewer="ForIctManager.showRemarkReviewerpenugasanRequest4" :showRemarkManager="ForIctManager.showRemarkManagerpenugasanRequest4"
          :showSpv="ForIctManager.showSpvpenugasanRequest4" printPdf="assignment_request" :showPersonnel1="ForIctManager.showPersonnelpenugasanRequest4" @get-data="getIct5" Active="0" 
          @show-loading="showLoading" @hide-loading="hideLoading" :showForDashboard=true
        />
