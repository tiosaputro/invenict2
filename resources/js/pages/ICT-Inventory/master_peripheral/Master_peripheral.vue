...
export default {
  ...
  methods: {
    ...
    CetakExcel(){
      ...
      this.loading = true;
       this.axios.get('api/report-master-excel',{headers: {'Content-Type': 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'},responseType: 'arraybuffer',}).then((response)=>{
