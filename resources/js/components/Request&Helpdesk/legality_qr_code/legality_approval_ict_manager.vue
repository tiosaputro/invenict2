  ...
  <Dialog></Dialog>
    ...
    >
        ...
        >
          ...
          <Column field="ireq_approval2" header="Approval By" :sortable="true" style="min-width:12rem"/>
          <Column field="date_approver2" header="Approval Date" :sortable="true" style="min-width:12rem">
          <template #body="slotProps">
