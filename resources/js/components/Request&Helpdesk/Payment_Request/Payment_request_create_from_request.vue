            ...
            <form @submit.prevent="CreatePayment">
              ...
              <div class="p-fluid formgrid grid">
               <div class="field grid col">
                   ...
                   <div class="field grid col" v-if="pr.ireqd_id">
                 ...
                 <div class="p-fluid formgrid grid">
               <div class="field grid col" v-if="pr.req">
                   ...
                   <div class="field grid col" v-if="pr.ireq_user">
                 ...
                 <div class="fluid formgrid grid" v-if="pr.ireq_date">
                  <div class="field grid col">
                  ...
                  <div class="field grid col" v-if="pr.bu">
