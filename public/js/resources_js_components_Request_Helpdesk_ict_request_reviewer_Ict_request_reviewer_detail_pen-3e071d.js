...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".attachment-image[data-v-3a92614f] {\n  width: 50px;\n  box-shadow: 0 3px 6px rgba(0, 0, 0, 0.16), 0 3px 6px rgba(0, 0, 0, 0.23);\n}\n.p-button.youtube[data-v-3a92614f] {\n  cursor: pointer;\n  background: linear-gradient(to left, var(--pink-600) 50%, var(--pink-700) 50%);\n  background-size: 200% 100%;\n  background-position: right bottom;\n  transition: background-position 0.5s ease-out;\n  color: #fff;\n  border-color: var(--pink-700);\n}\n.p-button.youtube[data-v-3a92614f]:hover {\n  background-position: left bottom;\n}\n.template .p-button.twitter[data-v-3a92614f] {\n  background: linear-gradient(to left, var(--blue-400) 50%, var(--blue-500) 50%);\n  background-size: 200% 100%;\n  background-position: right bottom;\n  transition: background-position 0.5s ease-out;\n  color: #fff;\n  border-color: var(--blue-500);\n}\n.template .p-button.twitter[data-v-3a92614f]:hover {\n  background-position: left bottom;\n}\n.template .p-button.twitter i[data-v-3a92614f] {\n  background-color: var(--blue-500);\n}\n.template .p-button.twitter[data-v-3a92614f]:focus {\n  box-shadow: 0 0 0 1px var(--blue-200);\n}", ""]);
// Exports
